function [link_statistics H_IC] = LTE_SP_TX_RX(eNodeB, UE, LTE_common_params, LTE_link_params, LTE_simu_params)
...
for i = 1:N_BS
    for j = 1:N_MS
        ...
        [tx_data_crs{i,j} LTE_link_params] = LTE_Add_RS(LTE_common_params, LTE_link_params, 'CRS', tx_precoded_data{i,j});
...
%     % LTE_link_params = LTE_Initialization(LTE_common_params,LTE_link_params,LTE_simu_params);
