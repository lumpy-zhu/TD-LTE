...
%   G = INTERP_GAIN_C(PAT, ANGLES, DATA, METHOD) are the complex antenna
...
%   same azimuth grid. 
%   
%   METHOD is a string defining interpolation method. The recommended
%   methods are: 'linear'        =   linear interpolation    'cspline'
%   =   cubic spline with periodic boundary conditions 'nearest'       =
%   rounds to nearest known point
%
...
%
%   Usage of this function requires that interp_gain_mex.c is compiled.  To
%   compile, type 
%
...
%   
%   It is recommended that the antenna field patterns in PAT are given  so
%   that there are no duplicate points in ANGLES and that the  support of
%   the interpolated function spans over the entire azimuth angle, i.e. 360
%   degrees. 
%
